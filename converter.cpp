...
{
        alfa2beta( ist, std::cout, baseBIP39::readCze, 2048, 2048, 1, baseBIP39::writeEng );
}
...
{
        alfa2beta( ist, std::cout, baseBIP39::readEng, 2048, 58, 1.8778, base58::write );
}

void b58toEng ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base58::read, 58, 2048, 0.5325, baseBIP39::writeEng );
}
...
{
        alfa2beta( ist, std::cout, baseBIP39::readCze, 2048, 10, 3.3114, base10::write );
}

void eng2dec ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, baseBIP39::readEng, 2048, 10, 3.3114, base10::write );
}

void dec2cze ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base10::read, 10, 2048, 0.3020, baseBIP39::writeCze );
}

void dec2eng ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base10::read, 10, 2048, 0.3020, baseBIP39::writeEng );
}
...
{
        alfa2beta( ist, std::cout, base10::read, 10, 58, 0.5671, base58::write );
}

void b58toDec ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base58::read, 58, 10, 1.7635, base10::write );
}
...
{
        alfa2beta( ist, std::cout, baseASCII::read, 256, 16, 2.0001, base16::write );
}

void b58toB16 ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base58::read, 58, 16, 1.4645, base16::write );
}

void b10toB16 ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base10::read, 10, 16, 0.8305, base16::write );
}

void cze2b16 ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, baseBIP39::readCze, 2048, 16, 2.7501, base16::write );
}

void eng2b16 ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, baseBIP39::readEng, 2048, 16, 2.7501, base16::write );
}
...
{
        alfa2beta( ist, std::cout, base16::read, 16, 58, 0.6829, base58::write );
}

void b16toB10 ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base16::read, 16, 10, 1.2042, base10::write );
}

void b16toCze ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base16::read, 16, 2048, 0.3637, baseBIP39::writeCze );
}
void b16toEng ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base16::read, 16, 2048, 0.3637, baseBIP39::writeEng );
}

void b16toAscii ( std::istream & ist, std::ostream & ost )
{
        alfa2beta( ist, std::cout, base16::read, 16, 256, 0.5001, baseASCII::write );
}
